			...
			<div className='form-page'>
				<div className='desc-text'>
					<p>
						...
						familiarize with Meshery, the Layer5 team will send you additional
						information about the early access program.
					</p>
					<img
						src={mesheryCloud}
					...
					<Formik
						...
						<Form className='form1' method='post'>
							...
							<div className='accounts'>
								...
								<p>
									Choose between Twitter, Google, LinkedIn, and GitHub, provide
									the username/handle of your user account for your preferred
									identity provider. When enrolled, participants will receive a
									free Meshery Cloud account and have full access to the Meshery
									Playground early access program for each of the following user
									accounts that you provide. Please provide at least one
									account.
								</p>
								{validateAccounts && (
									<p style={{ margin: '0px', color: 'red' }}>{errorAccounts}</p>
								)}
								<div className='accounts_group'>
									<label htmlFor='google' className='form-name'>
										Google
									</label>
									<Field
										type='email'
										...
										pattern='[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$'
									/>
									<label htmlFor='github' className='form-name'>
										GitHub
									</label>
									<Field
										type='text'
										...
										name='github'
									/>
									<label htmlFor='twitter' className='form-name'>
										Twitter
									</label>
									<Field
										type='text'
										...
										name='twitter'
									/>
									<label htmlFor='linkedin' className='form-name'>
										Linkedin
									</label>
									<Field
										type='text'
			...
			<>
				<div className='thankyou-box'>
					...
					<p>
						...
						<a href='mailto:meshmap@layer5.io'>meshmap@layer5.io</a>.
					</p>
					<h3 className='white'>
